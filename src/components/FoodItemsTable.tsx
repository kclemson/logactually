              ...
              <div key={`group-collapsed-${boundary.entryId}`} className="contents">
                <div className={cn('grid gap-0.5 items-center group', gridCols, highlightClasses)}>
                  ...
                  <div className="flex min-w-0">
                    ...
                    <div className={cn("flex-1 min-w-0 rounded pl-1 py-1 leading-snug focus-within:ring-2 focus-within:ring-focus-ring focus-within:bg-focus-bg", compact && "text-sm")}>
                       <DescriptionCell
                         value={groupName}
