...
export const FoodInput = forwardRef<HTMLDivElement, FoodInputProps>(
  ({ onSubmit, isLoading, shouldClear, onCleared }, ref) => {
    const { toast } = useToast();
    const [text, setText] = useState('');
    const [isListening, setIsListening] = useState(false);
    const [recognition, setRecognition] = useState<
      typeof window.webkitSpeechRecognition.prototype | null
    >(null);
