  ...
  return (
    <>
      <Dialog open={open && state !== 'prompting'} onOpenChange={onOpenChange}>
        <DialogContent className="left-4 right-4 top-12 translate-x-0 translate-y-0 w-auto max-w-[calc(100vw-32px)] sm:left-[50%] sm:right-auto sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:w-full sm:max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
