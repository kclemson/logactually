...
const PRIVACY_CONTENT = {
  ...
  howBuilt: {
    ...
    text: "This app was built using AI-assisted development tools. The security mechanisms described above — password hashing, data isolation, session management — are handled at the infrastructure level, not custom code. I use this app daily and use my own account for testing. I do also sometimes look at the items that have been logged (without any identifying user information) in order to understand how people are using the app, so I can make it better.",
    socialText:
