...
// Custom Google icon since lucide doesn't have one
const GoogleIcon = () => (
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          {errorMessage && (
            <div className="rounded-md bg-destructive/10 p-3 text-sm text-destructive mb-4">{errorMessage}</div>
          )}
          
          {!showEmailForm ? (
            // Main sign-in options - 4 parallel buttons
