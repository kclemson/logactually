    ...
    <div className="p-4 space-y-4">
      ...
      <div className="text-muted-foreground space-y-2">
        <div>
          ...
          <p className="ml-6 text-body">With entries: {stats?.users_with_entries ?? 0}</p>
          <p className="ml-6 text-body">Active in last 7 days: {stats?.active_last_7_days ?? 0}</p>
          <p className="ml-6 text-body">Created in last 7 days: {stats?.users_created_last_7_days ?? 0}</p>
        </div>
        
        <div>
          <p>Entries: {stats?.total_entries ?? 0}</p>
          <p className="ml-6 text-body">Average per user: {avgEntriesPerUser}</p>
          <p className="ml-6 text-body">Created in last 7 days: {stats?.entries_created_last_7_days ?? 0}</p>
        </div>
      </div>
