...
const History = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={swipeHandlers.ref} onTouchStart={swipeHandlers.onTouchStart} onTouchEnd={swipeHandlers.onTouchEnd} style={{ touchAction: 'none' }} className="min-h-[calc(100dvh-8rem)] md:min-h-0">
        <div
