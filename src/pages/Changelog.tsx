...
{ date: "Feb-17", text: "Tweaked UX of exercise log so that if a given day only has cardio and no strength training logged, the sets/reps/lbs will be hidden." },
...
export const LAST_UPDATED = "Feb-17-26";
// ============================================
