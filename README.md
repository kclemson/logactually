...
Once food tracking was working the way I liked, I then added exercise logging (my watch doesn't do a great job tracking weight-lifting workouts). And then after that, custom logs for things like body weight, blood pressure, sleep — classic "if you give a mouse (PM) a cookie (MVP)...". See the changelog at [https://logactually.com/changelog](https://logactually.com/changelog) for more up to date info on the features I've added recently.

It also has a demo mode if you want to poke around without creating an account - try it out at [logactually.com](https://logactually.com). 
