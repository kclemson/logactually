...
export const CANONICAL_EXERCISES: CanonicalExercise[] = [
  ...
  { key: 'dumbbell_press', name: 'Dumbbell Press', aliases: ['db press', 'dumbbell bench'], primaryMuscle: 'Chest', secondaryMuscles: ['Triceps'] },
  { key: 'chest_fly', name: 'Chest Fly', aliases: ['pec fly', 'fly machine', 'cable fly', 'dumbbell fly'], primaryMuscle: 'Chest' },
  ...
  // Upper Body - Pull
  { key: 'lat_pulldown', name: 'Lat Pulldown', aliases: ['pulldown', 'cable pulldown', 'pull down machine', 'wide grip pulldown'], primaryMuscle: 'Back' },
  { key: 'pull_up', name: 'Pull Up', aliases: ['pullup', 'chin up', 'chinup', 'assisted pull up'], primaryMuscle: 'Back' },
  ...
  { key: 'rear_delt_fly', name: 'Rear Delt Fly', aliases: ['reverse fly', 'rear delt', 'reverse pec deck'], primaryMuscle: 'Shoulders' },
  ...
  // Compound / Full Body
  { key: 'deadlift', name: 'Deadlift', aliases: ['conventional deadlift', 'barbell deadlift', 'dead lift'], primaryMuscle: 'Quads', secondaryMuscles: ['Hamstrings', 'Glutes', 'Hips', 'Lower Back'] },
  { key: 'sumo_deadlift', name: 'Sumo Deadlift', aliases: ['sumo', 'wide stance deadlift'], primaryMuscle: 'Quads', secondaryMuscles: ['Hamstrings', 'Glutes', 'Hips'] },
  { key: 'trap_bar_deadlift', name: 'Trap Bar Deadlift', aliases: ['hex bar deadlift', 'hex bar'], primaryMuscle: 'Quads', secondaryMuscles: ['Hamstrings', 'Glutes', 'Lower Back'] },
