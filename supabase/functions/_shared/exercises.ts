...
export const CANONICAL_EXERCISES: CanonicalExercise[] = [
  ...
  { key: 'leg_curl', name: 'Leg Curl', aliases: ['lying leg curl', 'prone leg curl'], primaryMuscle: 'Hamstrings' },
  { key: 'seated_leg_curl', name: 'Seated Leg Curl', aliases: ['seated hamstring curl', 'hamstring curl', 'hamstring curl machine'], primaryMuscle: 'Hamstrings' },
