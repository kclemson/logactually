...
serve(async (req) => {
  ...
  try {
    ...
    const limitedDescriptions = descriptions.slice(0, 20).map((d: string) => 
    ...
    console.log("Generated meal name:", suggestedName);
    ...
    console.error("Error in suggest-meal-name:", error);
    return new Response(
